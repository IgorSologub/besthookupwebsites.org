...
public class BlogPage extends BasePage {
    ...
    private final By sliderBlock = By.xpath("(//div[@class='uIzmiNJZHJ'])[8]");
    private final By scrollToSlider = By.xpath("(//h2[@class='IWt9P5ijp'])[6]");

    public BlogPage topPostBlogButtonClick (int numButton) {
        By blogButton = By.xpath("(//a[@class='k2ydAak6'])[" + numButton + "]");
        driver.findElement(blogButton).click();
        return this;
    }

    public BlogPage topPostButtonClick (int numButton) {
        By topPostButton = By.xpath("(//a[@class='tLa-slt'])[" + numButton + "]");
