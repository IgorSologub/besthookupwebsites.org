...
public class BasePage {
    ...
    private final By mainLogoButton = By.xpath("//a[@class='POCvcAkWLU']");
    private final By headerMenuOpen = By.xpath("//button[@class='hXYTB js-modal-btn']");
    private final By languageMenuOpen = By.xpath("(//a[@class='cvAXG3as tzKkoLTSQbv js-header-drop-btn '])[4]");
    ...
    public BasePage headerButtonClick (int numButton) {
        By headerButton = By.xpath("(//a[@class='cvAXG3as '])[" + numButton + "]");
        driver.findElement(headerButton).click();
        return this;
    }

    public BasePage headerMenuOpen () {
        By headerButton = By.xpath("(//a[@class='cvAXG3as '])[2]");
    ...
    public BasePage footerButtonClick (int numButton) {
        By footerButton = By.xpath("(//a[@class='rlKZNqjDt'])[" + numButton + "]");
